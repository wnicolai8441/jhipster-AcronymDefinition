...
public class Acronym implements Serializable {
    ...
    @JsonIgnoreProperties(value = { "acronyms" }, allowSetters = true)
    ...
    public Acronym image(byte[] image) {
        this.setImage(image);
        return this;
    }
    ...
    public Acronym imageContentType(String imageContentType) {
    ...
    public Acronym subContext(SubContext subContext) {
        this.setSubContext(subContext);
        return this;
    }
