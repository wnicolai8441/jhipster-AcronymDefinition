...
public class SubContextResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<SubContextDTO>> getAllSubContexts(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of SubContexts");
        Page<SubContextDTO> page = subContextService.findAll(pageable);
