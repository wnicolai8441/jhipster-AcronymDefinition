      ...
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {acronymEntity.image ? (
              <div>
                {acronymEntity.imageContentType ? (
                  <a onClick={openFile(acronymEntity.imageContentType, acronymEntity.image)}>
                    <img src={`data:${acronymEntity.imageContentType};base64,${acronymEntity.image}`} style={{ maxHeight: '30px' }} />
                  </a>
                ) : null}
                <span>
                  {acronymEntity.imageContentType}, {byteSize(acronymEntity.image)}
                </span>
              </div>
            ) : null}
          </dd>
          <dt>
            <Translate contentKey="acronymDefinitionApp.acronym.subContext">Sub Context</Translate>
          </dt>
          <dd>{acronymEntity.subContext ? acronymEntity.subContext.name : ''}</dd>
          <dt>
