...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './acronym.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACRONYM_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACRONYM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACRONYM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACRONYM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACRONYM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACRONYM actions', async () => {
      const expectedActions = [
        {
