...
class AcronymResourceIT {
    ...
    public static Acronym createEntity(EntityManager em) {
        Acronym acronym = new Acronym()
            .termOrAcronym(DEFAULT_TERM_OR_ACRONYM)
            .name(DEFAULT_NAME)
    ...
    public static Acronym createUpdatedEntity(EntityManager em) {
        Acronym acronym = new Acronym()
            .termOrAcronym(UPDATED_TERM_OR_ACRONYM)
            .name(UPDATED_NAME)
    ...
    void createAcronym() throws Exception {
        ...
        assertThat(testAcronym.getImage()).isEqualTo(DEFAULT_IMAGE);
        assertThat(testAcronym.getImageContentType()).isEqualTo(DEFAULT_IMAGE_CONTENT_TYPE);
    }
    ...
    void putExistingAcronym() throws Exception {
        ...
        assertThat(testAcronym.getImage()).isEqualTo(UPDATED_IMAGE);
        assertThat(testAcronym.getImageContentType()).isEqualTo(UPDATED_IMAGE_CONTENT_TYPE);
    }
