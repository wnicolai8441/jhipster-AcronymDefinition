...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBCONTEXT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBCONTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBCONTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBCONTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBCONTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBCONTEXT actions', async () => {
      const expectedActions = [
        {
