...
public class Context implements Serializable {
    ...
    public void setSubContexts(Set<SubContext> subContexts) {
        if (this.subContexts != null) {
            this.subContexts.forEach(i -> i.removeContext(this));
        }
        if (subContexts != null) {
            subContexts.forEach(i -> i.addContext(this));
        }
