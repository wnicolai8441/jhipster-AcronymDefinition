...
class AcronymTest {
    ...
    void subContextTest() throws Exception {
        ...
        acronym.setSubContext(subContextBack);
        assertThat(acronym.getSubContext()).isEqualTo(subContextBack);

        acronym.subContext(null);
        assertThat(acronym.getSubContext()).isNull();
    }
