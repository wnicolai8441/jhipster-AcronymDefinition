...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './context.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTEXT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTEXT actions', async () => {
      const expectedActions = [
        {
